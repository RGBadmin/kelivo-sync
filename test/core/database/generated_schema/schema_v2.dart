...
class SyncDirtyRows extends Table with TableInfo {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  SyncDirtyRows(this.attachedDatabase, [this._alias]);
  late final GeneratedColumn<String> scope = GeneratedColumn<String>(
    ...
    requiredDuringInsert: true,
    $customConstraints:
        'NOT NULL CHECK (scope IN (\'conversation\', \'entities\', \'settings\'))',
  );
  late final GeneratedColumn<String> entityId = GeneratedColumn<String>(
    'entity_id',
    aliasedName,
  ...
  late final GeneratedColumn<int> quiet = GeneratedColumn<int>(
    'quiet',
    aliasedName,
    false,
    type: DriftSqlType.int,
    requiredDuringInsert: false,
    $customConstraints: 'NOT NULL DEFAULT 1 CHECK (quiet IN (0, 1))',
    defaultValue: const CustomExpression('1'),
  );
  @override
  List<GeneratedColumn> get $columns => [
  ...
  @override
  SyncDirtyRows createAlias(String alias) {
    return SyncDirtyRows(attachedDatabase, alias);
  }
...
class SyncTombstoneRows extends Table with TableInfo {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  SyncTombstoneRows(this.attachedDatabase, [this._alias]);
  late final GeneratedColumn<String> kind = GeneratedColumn<String>(
    'kind',
    aliasedName,
    false,
  ...
  @override
  SyncTombstoneRows createAlias(String alias) {
    return SyncTombstoneRows(attachedDatabase, alias);
  }

  @override
  List<String> get customConstraints => const ['PRIMARY KEY(kind, entity_id)'];
  @override
  bool get dontWriteConstraints => true;
}

class SyncMetaRows extends Table with TableInfo {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  SyncMetaRows(this.attachedDatabase, [this._alias]);
  late final GeneratedColumn<String> key = GeneratedColumn<String>(
    'key',
    aliasedName,
    false,
  ...
  @override
  SyncMetaRows createAlias(String alias) {
    return SyncMetaRows(attachedDatabase, alias);
  }
...
class DatabaseAtV2 extends GeneratedDatabase {
  ...
  late final SyncDirtyRows syncDirtyRows = SyncDirtyRows(this);
  late final SyncTombstoneRows syncTombstoneRows = SyncTombstoneRows(this);
  late final SyncMetaRows syncMetaRows = SyncMetaRows(this);
